                ...
                {filteredArticles.map((article) => (
                    <Card key={article.id} className="flex flex-col justify-between hover:opacity-80">
                        ...
                        <CardFooter className="flex justify-between">
                            <Link href={`/article/${article.id}`} target='_blank' className='inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none h-9 px-3 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-primary bg-background hover:bg-accent hover:text-accent-foreground w-full'>
                                Read Article
                            </Link>
                        </CardFooter>
                    </Card>
