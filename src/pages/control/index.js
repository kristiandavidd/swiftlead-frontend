...
export default function Control() {
    ...
    useEffect(() => {
        ...
        const fetchDailyData = async () => {
            const res = await axios.get('https://swiftlead-backend-production.up.railway.app/control/daily');
        ...
        const fetchMonthlyData = async () => {
            const res = await axios.get('https://swiftlead-backend-production.up.railway.app/control/monthly');
            const suhu = res.data.map((d) => d.avgSuhu);
            const kelembapan = res.data.map((d) => d.avgKelembapan);
